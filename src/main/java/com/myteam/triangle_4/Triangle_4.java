 ...
 * @author MinhLai
 */
public class Triangle_4 extends javax.swing.JFrame {
    ...
    public void createTable(int input, int max, int min) {
        ...
        model.addColumn("B");
        model.addColumn("C");
        model.addColumn("Expected Output");
        ...
        for (var i = 0; i < input * 3 - 2; i++) {
            ...
            model.addRow(new Object[]{i + 1, side1, side2, side3, expected});
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Triangle_4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
